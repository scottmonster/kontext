export const samplemd = `\#\# Markdown output 🛫
...
The editor\-produced Markdown output supports most essential features, like \[links\]\(https://ckeditor\.com/\), \*\*different\*\* kinds of \_emphasis\_, \`inline code formatting\`, or code blocks:
...
| \-\-\- | \-\-\- |
| \*\*Bold\*\* | Type \`\*\*\` or \`\_\_\` around your text\. |
| \_Italic\_ | Type \`\*\` or \`\_\` around your text\. |
